...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO failed_orders (id, customer_name, address, phone_01, phone_02, product_name, quantity, total_amount, weight, courier_charge, created_at) 
...
<div class="container my-5">
    ...
    <br><br><h2>Failed Orders (Failed to deliver - According to various reasons)</h2><br>
    ...
    <table class="table">
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <a class='btn btn-danger btn-sm' href='/courier/delete3.php?id={$row['id']}'>Delete</a>
            </td>
            </tr>
            ";
        }
